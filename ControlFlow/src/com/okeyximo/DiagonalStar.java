...
public class DiagonalStar {
            ...
            for (int row = 0; row < number; row++){
                for (int column = 0; column < number; column++){
                    if (row == 0 || row == number - 1 || column == 0 ||
                            ...
                            || column == number - 1) System.out.print("*");
    ...
    public static void printSquareStarExplanation(int number){
        if (number < 5)
            System.out.println("Invalid Value");
        for (int row = 0; row < number; row++){
            for (int column = 0; column < number; column++){
                if (row == number - 1) System.out.print("1");
                else if (row == 0) System.out.print("1");
                else if (column == 0) System.out.print("2");
                else if (column == number - 1) System.out.print("3");
                else if (column == row) System.out.print("4");
                else if (column == number - row - 1) System.out.print("5");
                else System.out.print(" ");
            }
            System.out.println();
        }
